...
themeColor: "#137300"
themeColor: "#137300f7"
coverImage: https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410225058-spring-security.png
---
...
![Authentication 的子类](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410205710-paste-14c1241c35eae595c084cbd88b7de5ed-1.png)
...
![UserDetailsService 实现类](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410205718-paste-a1f7cf5eae7ff958b56e9b957fb59564-1.png)
...
![GrantedAuthority 实现类](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410205724-paste-8cfd4b99089c166ac5741025bf065e2c-1.png)
...
![GenericFilterBean 的子类](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410205823-paste-c45638a211fedcc4fd85887ffbdcbf31-1.png)
...
![AbstractAuthenticationProcessingFilter](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410205830-paste-e5357577f4468f28c4c7bc1edc04d5c9-1.png)

![UsernamePasswordAuthenticationFilter](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410205837-paste-9d319d9ed7ed0ff29f792d5a864f3e4b-1.png)

`BasicAuthenticationFilter` 只会处理请求头中包含 `Authorization` 并且以 `basic ` 开头的请求

![BasicAuthenticationFilter](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410205843-paste-b1f8722052149ab3c6b2caa303ca8f87-1.png)
...
![进行身份认证](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410205850-paste-296cca41d6b62f63c94dbb13ff92f812-1.png)

通过源码可以看出，每个类型的身份认证过滤器在执行认证过程中都根据认证信息生成 `Authentication`。使用用户名和密码登录时，就会生成 `UsernamePasswordAuthenticationToken`。

![Authentication 的子类](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410205857-paste-14c1241c35eae595c084cbd88b7de5ed-1-20210410205857470.png)
...
![AbstractSecurityInterceptor](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410205902-paste-ec4fb03d6afc559e42d274462801b453-1.png)
...
![authenticateIfRequired() 中判断是否有必要进行认证](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410210011-paste-053e65ba32a8afab32214a6768c5f828-1.png)
...
![AffirmativeBased](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410210020-paste-57cccc4ac291ba21743f8e571694aa3a-1.png)
...
![ExceptionTranslationFilter](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410210030-paste-bfb4ffa4058c6516c0898998a02ae4e7-1.png)
