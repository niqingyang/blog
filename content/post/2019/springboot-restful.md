...
tags:
    ...
    - restful
coverColor: "#575a56f7"
coverImage: https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410225144-springboot-restful.png
---
...
![创建项目](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410223402-paste-b876dd0c7e6b2ba4710df29329b4bad1-1.png)

... 构建过程可能会比较慢

## 项目目录结构

![目录结构](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410223410-paste-14bca5ff20c21020edf647ebd59ef7e7-1.png)
...
![](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410223418-paste-9799ab6ba7c01295fcf89cd9e43bbee1-1.png)

## 测试

服务启动后，访问 `http//localhost8080/greeting`

![](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410223426-paste-74f8ca915eb8ca1ad8b93f49a59341f0-1.png)

访问使用 `name` 提供查询字符串参数的 `http//localhost8080/greetingname=acme.top`, 会发现 `content` 属性的值从 “Hello，World！” 变为了 “hello, acme.top！”

![](https://cdn.jsdelivr.net/gh/acme-top/static@master/images/2021/04/20210410223436-paste-c0bfb714c7ba2201064683fbb45d061f-1.png)
